<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="proposals-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            data-type="form" data-ajax-type="POST" data-form-id="proposals-list-table" data-url="{{ url('/proposals/delete') }}"
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/proposals/change-category') }}" 
            data-action-url="{{ urlResource('/proposals/change-category') }}"
